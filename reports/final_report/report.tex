...
\definecolor{codeyellow}{HTML}{E3DC17}
...
{"response": "{user=T(a,c)}"}
    ...
    \begin{table}[H]
        \center
        \scriptsize
        \begin{tabular}{ c|c|c|c|p{0.17\linewidth} }
            Identity & Function & Atom & Coll & Transient \\
            \hline
            admin@org3.gov & UpdateTable & PATIENT(hospital,age,allergy) & C & user1@owners.org, general,25,pollen\newline user2@owners.org, royal,46,nut \\
            admin@org2.ac & QueryTable & PATIENT(age,hospital,allergy) & C & user1@owners.org, 25,general,*** \newline user2@owners.org, ***,royal,nut \\
            \hline
            admin@org2.ac & UpdateTable & DEMAND(medicine,hospital,factor) & B & user1@owners.org, ,general,1.2 \newline user2@owners.org, claritin,royal,0.8 \\
            admin@org2.ac & QueryTable & DEMAND(medicine,hospital,factor) & B & user1@owners.org, ,***,1.2 \newline user2@owners.org, claritine,***,0.8 \\
            \hline
        ...
        \end{tabular}
        \caption{Table updating and querying}
        \label{table:updates}
    \end{table}
