...
installChannels() {
  ...
  docker exec -i cli.owners.org bash -c "source scripts/channel_fns.sh; fetchChannelAndJoinTls 'ch1' 'OwnersMSP' 'peer0.owners.org:7101' 'crypto/users/Admin@owners.org/msp' 'crypto/users/Admin@owners.org/tls' 'crypto-orderer/tlsca.orderer.org-cert.pem' 'orderer0.authorities.orderer.org:7030';"
}
...
installChaincodes() {
  if [ -n "$(ls "$CHAINCODES_BASE_DIR/private-data-chaincode")" ]; then
    ...
    chaincodeApprove "cli.org1.co" "peer0.org1.co:7041" "ch1" "private-data" "$version" "orderer0.authorities.orderer.org:7030" "OR('Org1MSP.member', 'Org2MSP.member', 'Org3MSP.member', 'OwnersMSP.member')" "false" "crypto-orderer/tlsca.orderer.org-cert.pem" "collections/private-data.json"
    ...
    chaincodeApprove "cli.org2.ac" "peer0.org2.ac:7061" "ch1" "private-data" "$version" "orderer0.authorities.orderer.org:7030" "OR('Org1MSP.member', 'Org2MSP.member', 'Org3MSP.member', 'OwnersMSP.member')" "false" "crypto-orderer/tlsca.orderer.org-cert.pem" "collections/private-data.json"
    ...
    chaincodeApprove "cli.org3.gov" "peer0.org3.gov:7081" "ch1" "private-data" "$version" "orderer0.authorities.orderer.org:7030" "OR('Org1MSP.member', 'Org2MSP.member', 'Org3MSP.member', 'OwnersMSP.member')" "false" "crypto-orderer/tlsca.orderer.org-cert.pem" "collections/private-data.json"
    ...
    chaincodeApprove "cli.owners.org" "peer0.owners.org:7101" "ch1" "private-data" "$version" "orderer0.authorities.orderer.org:7030" "OR('Org1MSP.member', 'Org2MSP.member', 'Org3MSP.member', 'OwnersMSP.member')" "false" "crypto-orderer/tlsca.orderer.org-cert.pem" "collections/private-data.json"
    printItalics "Committing chaincode 'private-data' on channel 'ch1' as 'Org1'" "U1F618"
    chaincodeCommit "cli.org1.co" "peer0.org1.co:7041" "ch1" "private-data" "$version" "orderer0.authorities.orderer.org:7030" "OR('Org1MSP.member', 'Org2MSP.member', 'Org3MSP.member', 'OwnersMSP.member')" "false" "crypto-orderer/tlsca.orderer.org-cert.pem" "peer0.org1.co:7041,peer0.org2.ac:7061,peer0.org3.gov:7081,peer0.owners.org:7101" "crypto-peer/peer0.org1.co/tls/ca.crt,crypto-peer/peer0.org2.ac/tls/ca.crt,crypto-peer/peer0.org3.gov/tls/ca.crt,crypto-peer/peer0.owners.org/tls/ca.crt" "collections/private-data.json"
  else
...
runDevModeChaincode() {
  ...
  if [ "$chaincodeName" = "private-data" ]; then
    ...
    chaincodeApprove "cli.org1.co" "peer0.org1.co:7041" "ch1" "private-data" "1.0" "orderer0.authorities.orderer.org:7030" "OR('Org1MSP.member', 'Org2MSP.member', 'Org3MSP.member', 'OwnersMSP.member')" "false" "" "collections/private-data.json"
    printHeadline "Approving 'private-data' for Org2 (dev mode)" "U1F60E"
    chaincodeApprove "cli.org2.ac" "peer0.org2.ac:7061" "ch1" "private-data" "1.0" "orderer0.authorities.orderer.org:7030" "OR('Org1MSP.member', 'Org2MSP.member', 'Org3MSP.member', 'OwnersMSP.member')" "false" "" "collections/private-data.json"
    printHeadline "Approving 'private-data' for Org3 (dev mode)" "U1F60E"
    chaincodeApprove "cli.org3.gov" "peer0.org3.gov:7081" "ch1" "private-data" "1.0" "orderer0.authorities.orderer.org:7030" "OR('Org1MSP.member', 'Org2MSP.member', 'Org3MSP.member', 'OwnersMSP.member')" "false" "" "collections/private-data.json"
    printHeadline "Approving 'private-data' for Owners (dev mode)" "U1F60E"
    chaincodeApprove "cli.owners.org" "peer0.owners.org:7101" "ch1" "private-data" "1.0" "orderer0.authorities.orderer.org:7030" "OR('Org1MSP.member', 'Org2MSP.member', 'Org3MSP.member', 'OwnersMSP.member')" "false" "" "collections/private-data.json"
    printItalics "Committing chaincode 'private-data' on channel 'ch1' as 'Org1' (dev mode)" "U1F618"
    chaincodeCommit "cli.org1.co" "peer0.org1.co:7041" "ch1" "private-data" "1.0" "orderer0.authorities.orderer.org:7030" "OR('Org1MSP.member', 'Org2MSP.member', 'Org3MSP.member', 'OwnersMSP.member')" "false" "" "peer0.org1.co:7041,peer0.org2.ac:7061,peer0.org3.gov:7081,peer0.owners.org:7101" "" "collections/private-data.json"
...
notifyOrgsAboutChannels() {
  ...
  notifyOrgAboutNewChannelTls "ch1" "OwnersMSP" "cli.owners.org" "peer0.owners.org" "orderer0.authorities.orderer.org:7030" "crypto-orderer/tlsca.orderer.org-cert.pem"
