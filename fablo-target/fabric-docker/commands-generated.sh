...
installChannels() {
  ...
  docker exec -i cli.org1.co bash -c "source scripts/channel_fns.sh; createChannelAndJoin 'ch1' 'Org1MSP' 'peer0.org1.co:7041' 'crypto/users/Admin@org1.co/msp' 'orderer0.auth.orderer.org:7030';"

  printItalics "Joining 'ch1' on  Org2/peer0" "U1F638"
  docker exec -i cli.org2.ac bash -c "source scripts/channel_fns.sh; fetchChannelAndJoin 'ch1' 'Org2MSP' 'peer0.org2.ac:7061' 'crypto/users/Admin@org2.ac/msp' 'orderer0.auth.orderer.org:7030';"
  printItalics "Joining 'ch1' on  Owners/peer0" "U1F638"
  docker exec -i cli.owners.org bash -c "source scripts/channel_fns.sh; fetchChannelAndJoin 'ch1' 'OwnersMSP' 'peer0.owners.org:7081' 'crypto/users/Admin@owners.org/msp' 'orderer0.auth.orderer.org:7030';"
}

installChaincodes() {
  if [ -n "$(ls "$CHAINCODES_BASE_DIR/private-data-chaincode")" ]; then
    printHeadline "Approving 'private-data' for Org1 (dev mode)" "U1F60E"
    chaincodeApprove "cli.org1.co" "peer0.org1.co:7041" "ch1" "private-data" "1.0" "orderer0.auth.orderer.org:7030" "OR('OwnersMSP.member', 'Org1MSP.member', 'Org2MSP.member')" "false" "" "collections/private-data.json"
    printHeadline "Approving 'private-data' for Org2 (dev mode)" "U1F60E"
    chaincodeApprove "cli.org2.ac" "peer0.org2.ac:7061" "ch1" "private-data" "1.0" "orderer0.auth.orderer.org:7030" "OR('OwnersMSP.member', 'Org1MSP.member', 'Org2MSP.member')" "false" "" "collections/private-data.json"
    printHeadline "Approving 'private-data' for Owners (dev mode)" "U1F60E"
    chaincodeApprove "cli.owners.org" "peer0.owners.org:7081" "ch1" "private-data" "1.0" "orderer0.auth.orderer.org:7030" "OR('OwnersMSP.member', 'Org1MSP.member', 'Org2MSP.member')" "false" "" "collections/private-data.json"
    printItalics "Committing chaincode 'private-data' on channel 'ch1' as 'Org1' (dev mode)" "U1F618"
    chaincodeCommit "cli.org1.co" "peer0.org1.co:7041" "ch1" "private-data" "1.0" "orderer0.auth.orderer.org:7030" "OR('OwnersMSP.member', 'Org1MSP.member', 'Org2MSP.member')" "false" "" "peer0.org1.co:7041,peer0.org2.ac:7061,peer0.owners.org:7081" "" "collections/private-data.json"
  else
...
installChaincode() {
  ...
  if [ "$chaincodeName" = "private-data" ]; then
    if [ -n "$(ls "$CHAINCODES_BASE_DIR/private-data-chaincode")" ]; then
      ...
      chaincodeApprove "cli.org1.co" "peer0.org1.co:7041" "ch1" "private-data" "$version" "orderer0.auth.orderer.org:7030" "OR('OwnersMSP.member', 'Org1MSP.member', 'Org2MSP.member')" "false" "" "collections/private-data.json"
      ...
      chaincodeApprove "cli.org2.ac" "peer0.org2.ac:7061" "ch1" "private-data" "$version" "orderer0.auth.orderer.org:7030" "OR('OwnersMSP.member', 'Org1MSP.member', 'Org2MSP.member')" "false" "" "collections/private-data.json"
      ...
      chaincodeApprove "cli.owners.org" "peer0.owners.org:7081" "ch1" "private-data" "$version" "orderer0.auth.orderer.org:7030" "OR('OwnersMSP.member', 'Org1MSP.member', 'Org2MSP.member')" "false" "" "collections/private-data.json"
      printItalics "Committing chaincode 'private-data' on channel 'ch1' as 'Org1'" "U1F618"
      chaincodeCommit "cli.org1.co" "peer0.org1.co:7041" "ch1" "private-data" "$version" "orderer0.auth.orderer.org:7030" "OR('OwnersMSP.member', 'Org1MSP.member', 'Org2MSP.member')" "false" "" "peer0.org1.co:7041,peer0.org2.ac:7061,peer0.owners.org:7081" "" "collections/private-data.json"
...
notifyOrgsAboutChannels() {
  ...
  notifyOrgAboutNewChannel "ch1" "Org1MSP" "cli.org1.co" "peer0.org1.co" "orderer0.auth.orderer.org:7030"
  notifyOrgAboutNewChannel "ch1" "Org2MSP" "cli.org2.ac" "peer0.org2.ac" "orderer0.auth.orderer.org:7030"
  notifyOrgAboutNewChannel "ch1" "OwnersMSP" "cli.owners.org" "peer0.owners.org" "orderer0.auth.orderer.org:7030"
